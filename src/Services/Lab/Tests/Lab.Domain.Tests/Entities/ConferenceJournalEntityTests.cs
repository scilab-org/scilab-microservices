...
public sealed class ConferenceJournalEntityTests
{
    ...
    public void Create_ShouldInitializeCorrectly()
    {
        ...
        var entity = ConferenceJournalEntity.Create(id, "ICSE 2024", "A*",
            "https://icse.org", "IEEE", templateId, "tex.tex", "pdf.pdf",
        ...
        entity.TemplateId.Should().Be(templateId);
    ...
    {
        var entity = ConferenceJournalEntity.Create(Guid.NewGuid(), "Name", null, null, null, Guid.NewGuid(), null, null);
    ...
    {
        var entity = ConferenceJournalEntity.Create(Guid.NewGuid(), "Old", null, null, null, Guid.NewGuid(), null, null);
        ...
        entity.Update(name: "New", ranking: "B", url: "https://new.org",
            ...
            style: "ACM", templateId: newTemplateId,
        ...
        entity.TemplateId.Should().Be(newTemplateId);
    ...
    {
        var entity = ConferenceJournalEntity.Create(Guid.NewGuid(), "Name", "A", null, null, Guid.NewGuid(), null, null);
        entity.Update();
    ...
    {
        var entity = ConferenceJournalEntity.Create(Guid.NewGuid(), "N", null, null, null, Guid.NewGuid(), null, null);
    ...
    {
        var entity = ConferenceJournalEntity.Create(Guid.NewGuid(), "N", null, null, null, Guid.NewGuid(), "old.tex", "old.pdf");
