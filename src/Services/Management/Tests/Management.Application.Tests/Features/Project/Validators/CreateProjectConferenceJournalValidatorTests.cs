...
public sealed class CreateProjectConferenceJournalValidatorTests : BaseTest
{
    private readonly CreateProjectConferenceJournalValidator _validator = new();

    [Fact]
    public async Task Validate_ShouldPass_WhenCommandIsValid()
    {
        // Arrange
        var command = new CreateProjectConferenceJournalCommand(Guid.NewGuid(), Guid.NewGuid());
    ...
    {
        // Arrange
        var command = new CreateProjectConferenceJournalCommand(Guid.Empty, Guid.NewGuid());
    ...
    {
        // Arrange
        var command = new CreateProjectConferenceJournalCommand(Guid.NewGuid(), Guid.Empty);
