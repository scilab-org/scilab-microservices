# Unit Test Report for DeleteAuthorRole

# 1. General Information

| Field | Value |
|------|------|
| className | DeleteAuthorRoleCommandHandler |
| functionName | DeleteAuthorRole |
...
|------|-------------|------|
| UTCID01 | WithExistingRole -> ShouldRemoveFromStore | N |
| UTCID02 | WithNonExistentId -> ShouldThrowClientValidationException | A |

# 3. Header Information

| Function Code | | Function Name | DeleteAuthorRole |
|---------------|---|---------------|-----------------|
