# Unit Test Report for DeleteJournal

# 1. General Information

| Field | Value |
|------|------|
| className | DeleteJournalCommandHandler |
...
|------|-------------|------|
| UTCID01 | WithExisting -> ShouldSoftDelete | N |
| UTCID02 | WithNonExistent -> ShouldThrowClientValidationException | A |

# 3. Header Information

| Function Code | | Function Name | DeleteJournal |
|---------------|---|---------------|-----------------|
