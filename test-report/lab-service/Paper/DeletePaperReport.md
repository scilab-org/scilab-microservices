# Unit Test Report for DeletePaper

# 1. General Information

| Field | Value |
|------|------|
| className | DeletePaperCommandHandler |
| functionName | DeletePaper |
...
|------|-------------|------|
| UTCID01 | WithExistingPaper -> ShouldRemoveFromStore | N |
| UTCID02 | WithNonExistentId -> ShouldThrowClientValidationException | A |

# 3. Header Information

| Function Code | | Function Name | DeletePaper |
|---------------|---|---------------|-----------------|
