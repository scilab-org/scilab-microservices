# Unit Test Report for GetCombinePaperById

# 1. General Information

| Field | Value |
|------|------|
| className | GetCombinePaperByIdHandler |
| functionName | GetCombinePaperById |
...
|------|-------------|------|
| UTCID01 | WithExistingPaperAndVersion -> ShouldReturnCombinedResult | N |
| UTCID02 | WithNonExistentPaper -> ShouldThrowNotFoundException | A |

# 3. Header Information

| Function Code | | Function Name | GetCombinePaperById |
|---------------|---|---------------|-----------------|
