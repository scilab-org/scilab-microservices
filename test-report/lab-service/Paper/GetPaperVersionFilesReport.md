# Unit Test Report for GetPaperVersionFiles

# 1. General Information

| Field | Value |
|------|------|
| className | GetPaperVersionFilesHandler |
| functionName | GetPaperVersionFiles |
...
|------|-------------|------|
| UTCID01 | WithExistingVersion -> ShouldReturnFiles | N |
| UTCID02 | WithWrongPaperId -> ShouldThrowClientValidationException | A |
| UTCID03 | WithNonExistentVersion -> ShouldThrowNotFoundException | A |

# 3. Header Information

| Function Code | | Function Name | GetPaperVersionFiles |
|---------------|---|---------------|-----------------|
