# Unit Test Report for GetVersionsByPaperId

# 1. General Information

| Field | Value |
|------|------|
| className | GetVersionsByPaperIdHandler |
| functionName | GetVersionsByPaperId |
...
|------|-------------|------|
| UTCID01 | WithExistingPaper -> ShouldReturnVersions | N |
| UTCID02 | WithNonExistentPaper -> ShouldThrowNotFoundException | A |

# 3. Header Information

| Function Code | | Function Name | GetVersionsByPaperId |
|---------------|---|---------------|-----------------|
