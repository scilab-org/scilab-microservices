# Unit Test Report for GetPaperAuthorById

# 1. General Information

| Field | Value |
|------|------|
| className | GetPaperAuthorByIdHandler |
| functionName | GetPaperAuthorById |
...
| Function Code | | Function Name | GetPaperAuthorById |
|---------------|---|---------------|-----------------|
