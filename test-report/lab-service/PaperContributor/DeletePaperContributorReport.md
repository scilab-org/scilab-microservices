# Unit Test Report for DeletePaperContributor

# 1. General Information

| Field | Value |
|------|------|
| className | DeletePaperContributorCommandHandler |
| functionName | DeletePaperContributor |
...
|------|-------------|------|
| UTCID01 | WithExistingEntity -> ShouldRemoveFromStore | N |
| UTCID02 | WithNonExistentId -> ShouldThrowNotFoundException | A |

# 3. Header Information

| Function Code | | Function Name | DeletePaperContributor |
|---------------|---|---------------|-----------------|
