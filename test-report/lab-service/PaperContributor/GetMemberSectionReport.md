# Unit Test Report for GetMemberSection

# 1. General Information

| Field | Value |
|------|------|
| className | GetMemberSectionQueryHandler |
| functionName | GetMemberSection |
...
| UTCID02 | WithContributors -> ShouldReturnMemberInfo | N |

# 3. Header Information

| Function Code | | Function Name | GetMemberSection |
|---------------|---|---------------|-----------------|
