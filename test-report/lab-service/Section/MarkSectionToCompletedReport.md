# Unit Test Report for MarkSectionToCompleted

# 1. General Information

| Field | Value |
|------|------|
| className | MarkSectionToCompletedHandler |
| functionName | MarkSectionToCompleted |
...
| UTCID02 | WhenContributorMissingOrReadOnly -> ShouldThrowUnauthorizedException | A |
| UTCID03 | WhenStatusIsNotInReview -> ShouldThrowClientValidationException | A |
| UTCID04 | WithValidData -> ShouldSetStatusToCompleted | N |

# 3. Header Information

| Function Code | | Function Name | MarkSectionToCompleted |
|---------------|---|---------------|-----------------|
