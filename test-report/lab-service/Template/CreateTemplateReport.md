# Unit Test Report for CreateTemplate

# 1. General Information

| Field | Value |
|------|------|
| className | CreateTemplateCommandHandler |
...
| UTCID02 | WithDuplicateCode -> ShouldThrowClientValidationException | A |

# 3. Header Information

| Function Code | | Function Name | CreateTemplate |
|---------------|---|---------------|-----------------|
