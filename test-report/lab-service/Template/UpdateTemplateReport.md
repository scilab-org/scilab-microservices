# Unit Test Report for UpdateTemplate

# 1. General Information

| Field | Value |
|------|------|
| className | UpdateTemplateCommandHandler |
...
| UTCID02 | WithNullFields -> ShouldKeepExisting | A |
| UTCID03 | WithNonExistentId -> ShouldThrowNotFoundException | A |

# 3. Header Information

| Function Code | | Function Name | UpdateTemplate |
|---------------|---|---------------|-----------------|
