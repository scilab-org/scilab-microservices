# Unit Test Report for CreateAffiliation

# 1. General Information

| Field | Value |
|------|------|
| className | CreateAffiliationCommandHandler |
| functionName | CreateAffiliation |
...
| UTCID02 | WithOptionalFields -> ShouldStoreAllFields | N |

# 3. Header Information

| Function Code | | Function Name | CreateAffiliation |
|---------------|---|---------------|-----------------|
