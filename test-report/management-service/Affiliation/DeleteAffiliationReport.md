# Unit Test Report for DeleteAffiliation

# 1. General Information

| Field | Value |
|------|------|
| className | DeleteAffiliationCommandHandler |
| functionName | DeleteAffiliation |
...
|------|-------------|------|
| UTCID01 | WithExistingAffiliation -> ShouldRemoveFromStore | N |
| UTCID02 | WithNonExistentId -> ShouldThrowClientValidationException | A |

# 3. Header Information

| Function Code | | Function Name | DeleteAffiliation |
|---------------|---|---------------|-----------------|
