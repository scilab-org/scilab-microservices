# Unit Test Report for GetAffiliationById

# 1. General Information

| Field | Value |
|------|------|
| className | GetAffiliationByIdHandler |
| functionName | GetAffiliationById |
...
|------|-------------|------|
| UTCID01 | WithExistingAffiliation -> ShouldReturnMappedResult | N |
| UTCID02 | WithNonExistentId -> ShouldThrowClientValidationException | A |

# 3. Header Information

| Function Code | | Function Name | GetAffiliationById |
|---------------|---|---------------|-----------------|
