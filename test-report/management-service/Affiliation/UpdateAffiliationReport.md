# Unit Test Report for UpdateAffiliation

# 1. General Information

| Field | Value |
|------|------|
| className | UpdateAffiliationCommandHandler |
| functionName | UpdateAffiliation |
...
| Function Code | | Function Name | UpdateAffiliation |
|---------------|---|---------------|-----------------|
