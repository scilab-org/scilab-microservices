# Unit Test Report for DeleteDomain

# 1. General Information

| Field | Value |
|------|------|
| className | DeleteDomainCommandHandler |
...
|------|-------------|------|
| UTCID01 | WithExistingDomain -> ShouldRemoveFromStore | N |
| UTCID02 | WithNonExistentId -> ShouldThrowClientValidationException | A |

# 3. Header Information

| Function Code | | Function Name | DeleteDomain |
|---------------|---|---------------|-----------------|
