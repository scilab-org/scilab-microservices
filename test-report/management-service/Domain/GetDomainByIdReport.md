# Unit Test Report for GetDomainById

# 1. General Information

| Field | Value |
|------|------|
| className | GetDomainByIdHandler |
...
|------|-------------|------|
| UTCID01 | WithExistingDomain -> ShouldReturnMappedResult | N |
| UTCID02 | WithNonExistentId -> ShouldThrowClientValidationException | A |

# 3. Header Information

| Function Code | | Function Name | GetDomainById |
|---------------|---|---------------|-----------------|
