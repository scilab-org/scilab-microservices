# Unit Test Report for DeleteUserAffiliation

# 1. General Information

| Field | Value |
|------|------|
| className | DeleteUserAffiliationCommandHandler |
| functionName | DeleteUserAffiliation |
...
| Function Code | | Function Name | DeleteUserAffiliation |
|---------------|---|---------------|-----------------|
