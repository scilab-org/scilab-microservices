# Unit Test Report for UpdateUserAffiliation

# 1. General Information

| Field | Value |
|------|------|
| className | UpdateUserAffiliationCommandHandler |
| functionName | UpdateUserAffiliation |
...
| Function Code | | Function Name | UpdateUserAffiliation |
|---------------|---|---------------|-----------------|
