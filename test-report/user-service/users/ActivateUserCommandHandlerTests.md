...
| Field | Value |
|-------|-------|
| className | ActivateUserCommandHandler |
| functionName | Handle |
| testClass | ActivateUserCommandHandlerTests |
| feature | user |
...
|-------|-------------|------|
| UTCID01 | Keycloak activates user successfully — return true | N |
...
| Test requirement | ActivateUserCommandHandler must call KeycloakService.ActivateUserAsync and return true on success, or propagate exceptions on failure. | | |
...
| **keycloakService.ActivateUserAsync** | | | |
...
| **Return** | | | |
| | true | O | |
| **keycloakService.ActivateUserAsync calls** | | | |
| | Times.Once | O | |
| **Exception** | | | |
| | none | O | |
